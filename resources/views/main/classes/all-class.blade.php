...
<head>
  ...
  <title>AdminLTE 3 | Classes</title>
          ...
          <div class="card shadow">
            <div class="card-header bg-primary">
              <div class="d-flex justify-content-around align-items-center">
                ...
                <div class="col-3"><a href="{{ route("new-class") }}" class="btn btn-success"><i class="fas fa-plus"></i> New</a></div>
              </div>
            </div>
            <div class="card-body">
                ...
                <tbody>
                  @foreach ($classes as $val)  
                    <tr>
                      ...
                      <td><a href="{{ route('edit-class',$val->unique_id) }}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a></td>
