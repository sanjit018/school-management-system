...
<head>
  ...
  <title>AdminLTE 3 | Teacher</title>
          ...
          <div class="card shadow">
            <div class="card-header bg-primary">
              <div class="d-flex justify-content-around align-items-center">
                ...
                <div class="col-3"><a href="{{ route("add-teacher") }}" class="btn btn-success"><i class="fas fa-plus"></i> New</a></div>
              </div>
            </div>
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach ($teacher as $val)  
                    <tr>
                      <td>{{$val->name}}</td>
                      <td><img src="{{asset('storage/'.$val->profile)}}" alt="" width="50" height="50" style="border-radius: 50%"></td>
                      <td>{{$val->email}}</td>
                      <td>{{$val->contact}}</td>
